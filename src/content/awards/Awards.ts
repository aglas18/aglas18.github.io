export const awardsList = [
    {
      date: "2024",
      title: "Horizon Award — Gold (Grip Rite)",
      description:
    ...
    {
      date: "2023",
      title: "Horizon Award — Gold (Muni-Link)",
      description:
    ...
    {
      date: "2022",
      title: "Horizon Award — Gold (Holiday Online Ads)",
      description:
    ...
    {
      date: "Jan 2024",
      title: "Highest Conversion Rate Increase — Arranmore Lighting",
      description:
    ...
    {
      date: "Jan 2024",
      title: "Fastest Rainmaker Project — JRM Construction Management",
      description:
    ...
    {
      date: "2024",
      title: "Most Profitable Rainmaker Project — CCA",
      description:
    ...
    {
      date: "Jan 2025",
      title: "Fastest Rainmaker Project — H2 Hospitalist Group",
      description:
    ...
    {
      date: "Jan 2025",
      title: "Most Profitable Rainmaker Project — H2 Hospitalist Group",
      description:
    ...
    {
      date: "Jan 2025",
      title: "Highest Conversion Rate Increase — Forta Corp",
      description:
