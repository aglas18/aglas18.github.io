...
caseSections:
  - type: mediaText
    ...
    body: >
      <p>
        The refreshed identity focused on simplifying the visual language while keeping the playful personality that makes the brand recognizable. Typography, color, and logo variations were refined into a more cohesive system across digital and physical applications.
      </p>
    image:
  ...
  - type: mediaText
    ...
    body: >
      <p>
        The website redesign focused on usability, hierarchy, and clearer user flow. The updated layouts help visitors quickly understand the cafe’s mission, explore adoptable cats, and book reservations with less friction.
      </p>
    image:
  ...
  - type: imageGrid
    ...
    images:
      ...
      - src: /assets/images/lancatster-cat-cafe/final-social.png
        alt: Social media concepts

  - type: mediaText
    mediaPosition: left
    eyebrow: Merchandise & Applications
    title: Extending the Brand Beyond Digital
    body: >
      <p>
